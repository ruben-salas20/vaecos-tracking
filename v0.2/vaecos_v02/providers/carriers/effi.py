...
class EffiCarrier:
    name: ClassVar[str] = "effi"
    BASE_URL: ClassVar[str] = "https://effi.com.co/tracking/index/{guide}"

    def __init__(self, config: CarrierConfig) -> None:
        self.timeout_seconds = config.timeout_seconds
        self.raw_html_dir = config.raw_html_dir
        self.save_raw_html = config.save_raw_html
